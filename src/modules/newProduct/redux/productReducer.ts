...
export const setLoadingProductData = createCustomAction(
  "product/setLoadingProductData",
  (loading: boolean) => ({
    loading,
  })
);
...
export const setConditions = createCustomAction(
  "product/setConditions",
  (data: Array<ICondition>) => ({
    data,
  })
);
export const setShippings = createCustomAction(
  "product/setShippings",
  (data: Array<IShipping>) => ({
    data,
  })
);
export const setProductDetail = createCustomAction(
