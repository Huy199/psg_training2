...
import {
  validDateyyyyMMddRegex,
  validNameRegex,
  validNumberWithDecimalRegex,
} from "../../utils";
...
const validateShippingToZones = (
  value: Array<{ id: number; price: string }>,
...
export const validationCreateProductSchema = (
  ...
  return yup.object({
    ...
    name: yup
      .string()
      .matches(validNameRegex, "nameInvalid")
      ...
      .of(
        yup.object().shape({
          id: yup
            .number()
            .oneOf(
              [1, ...[...shippings].map((item) => +item.id)],
              "shippingToZoneIdInvalid"
            ),
          price: yup
            .string()
            .matches(validNumberWithDecimalRegex, "shippingToZonePriceInvalid"),
        })
      )
    ...
    price: yup
      .number()
      .moreThan(0, "priceMustGreaterThanZero")
      .required("priceRequired"),
    sale_price_type: yup
      .string()
      .oneOf(["$", "%"], "salePriceTypeInvalid")
      .required("salePriceTypeRequired"),
    arrival_date: yup
      .string()
      .matches(validDateyyyyMMddRegex, "arrivalDateInvalid")
      .required("arrivalDateRequired"),
    inventory_tracking: yup.number(),
    quantity: yup
      .number()
      .moreThan(0, "quantityMustGreaterThanZero")
      .required("quantityRequired"),
    sku: yup.string(),
    participate_sale: yup.string(),
    sale_price: yup
      .string()
      .matches(validNumberWithDecimalRegex, "salePriceInvalid"),
    og_tags_type: yup
      .string()
      .oneOf(["0", "1"], "ogTagsTypeInvalid")
      .required("ogTagsTypeRequired"),
    og_tags: yup.string(),
    meta_desc_type: yup
      .string()
...
export const validateUpdateProduct = (
  ...
  return {
    ...
    shipping_to_zones: validateShippingToZones(
    ...
    meta_keywords: "",
    product_page_title: "",
    facebook_marketing_enabled: validateFacebookMarketingEnabled(
      values.facebook_marketing_enabled
    ),
