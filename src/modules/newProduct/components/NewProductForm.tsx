...
import { ICreateProductParams } from "../../../models/products";
...
const CreateProductForm = (props: Props) => {
  ...
  const handleAddShippingZone = (id?: number) => {
    ...
    const isShippingZoneIn = [...formik.values.shipping_to_zones].some(
      (item) => item.id === id
    );
    if (isShippingZoneIn) {
      return;
        ...
        <Grid container width={1} position="relative">
          <Grid pl={4} pt={2} pb={2} item xs={8}>
              ...
              <Grid item xs>
                <Autocomplete
                  ...
                  getOptionLabel={(option) =>
                    option.login ? option.login : option.name
                  }
            ...
            <Grid container width={1} p={2} spacing={3}>
              ...
              <Grid item xs>
                <Editor
                  apiKey="t6xrmayzltb0tjkmoefri48ninsnr2opxc6xjvifbigs5za2"
